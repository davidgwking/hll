...
function hash(string) {
  // empty string hashed with murmurhash3 produces 0, though it should be a valid input.
  // we will hash empty string to produce a consistent alternative
  if (!string) string = crypto.createHash('sha1').update(string, 'utf8').digest('hex');
